         ...
         <div class="card-body">
            <form action="{{route('categories.update',['category'=>$category])  }}" method="POST">
               ...
               <div class="form-group">
                  ...
                  <input id="input_category_title" value="{{ old('title', $category->title) }}" name="title" type="text" class="form-control 
               ...
               <div class="form-group">
                  ...
                  <select id="select_category_parent" name="parent_category" data-placeholder="{{ trans('categories.form_control.select.parent_category.placeholder') }}" class="custom-select w-100">
                     <!-- Cái hàm của nợ này là giúp hiên lên kết cấu bố mẹ nhà nó -->
                     @if(old('parent_category',$category->parent))
                     <option value="{{ old('parent_category',$category->parent)}}" selected>
                        {{ old('parent_category',$category->parent)}}
                     </option>
                     @endif
                  </select>
               </div>
               ...
               <div class="form-group">
                  ...
                  <textarea id="input_category_description" name="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="{{ trans('categories.form_control.textarea.description.placeholder') }}">
...
<script>
   // sự kiện loại bỏ ký tự đặc biệt khỏi title để sử dụng auto generateSlug
   $(function() {
      ...
      // event:input title
      // sự kiện bắt tên dự án xuống slug
      ...
      // event:thumbnail
      // sự kiện bắt file dữ liệu vào ứng dụng
