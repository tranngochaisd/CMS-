                    ...
                    <div class="row d-flex align-items-stretch">
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_post_title" value="{{old('title') }}" name="title" type="text" class="form-control @error('slug') is-invalid @enderror" placeholder="{{ trans('posts.form_control.input.title.placeholder') }}" />
                                @error('title')
                            ...
                            <div class="form-group">
                                ...
                                <input id="input_post_slug" value="{{old('slug') }}" name=" slug" type="text" class="form-control  @error('slug') is-invalid @enderror" placeholder="{{ trans('posts.form_control.input.slug.placeholder') }}" readonly />
                                @error('slug')
                                <span class="invalid-feedback">
                                    <strong>
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input id="input_post_thumbnail" name="thumbnail" value="{{old('thumbnail') }}" type=" text" class="form-control  @error('thumbnail') is-invalid @enderror" placeholder="{{ trans('posts.form_control.input.thumbnail.placeholder') }}" readonly />
                                    @error('thumbnail')
                                    <span class="invalid-feedback">
                                        <strong>
                                            {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="input_post_content" name="content" placeholder="" class="form-control  @error('content') is-invalid @enderror" rows="20">
                                {{old('content') }}
                                </textarea>
                                @error('content')
                                <span class="invalid-feedback">
...
<script>
    $(document).ready(function() {
        ...
        // Thiết lập khung insert cho content(nội dung)
